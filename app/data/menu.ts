...
export const MENU: MenuItem[] = [
  ...
  {
    id: "bloom-dirty-matcha",
    name: "Bloom Dirty Matcha",
    category: "drinks",
    description:
      "A ceremonial matcha latte finished with a shot of espresso poured over the top.",
    image: "/images/menu/bloom-dirty-matcha.png",
    price: 8,
    available: true,
    primaryFlavors: ["matcha", "roasted", "bittersweet", "creamy"],
    sweetness: 2,
    matchaIntensity: 4,
    caffeine: "high",
    temperature: "hot-or-iced",
    texture: ["creamy", "layered"],
    pairsWith: ["matcha-basque-cheesecake", "black-sesame-mochi"],
    ingredients: ["ceremonial matcha", "espresso", "whole milk"],
    allergens: ["milk"],
    containsDairy: true,
    plantMilkAvailable: true,
    vegan: false,
  ...
  },
  {
    ...
    category: "drinks",
    description:
      "Toasted black sesame paste blended into a ceremonial matcha latte for a deep, nutty finish.",
    image: "/images/menu/black-sesame-matcha-latte.png",
    price: 8,
    available: true,
    primaryFlavors: ["black sesame", "nutty", "roasted", "matcha"],
    sweetness: 3,
    matchaIntensity: 3,
    caffeine: "medium",
    temperature: "hot-or-iced",
  ...
  {
    id: "peach-blossom-matcha",
    name: "Peach Blossom Matcha",
    category: "drinks",
    description:
      "White peach puree layered under iced matcha and finished with sakura cold foam. A summer seasonal.",
    image: "/images/menu/peach-blossom-matcha.png",
    price: 8,
    available: true,
    primaryFlavors: ["peach", "floral", "matcha", "fruity"],
    sweetness: 4,
    matchaIntensity: 2,
    caffeine: "medium",
    temperature: "iced",
    texture: ["layered", "juicy", "creamy"],
    pairsWith: ["momo-nerikiri", "yuzu-sakura-sorbet"],
    ingredients: [
      "white peach puree",
      "ceremonial matcha",
      "whole milk",
  ...
  },
  {
    ...
    pairsWith: ["ceremonial-matcha", "bloom-dirty-matcha"],
  ...
  },
  {
    ...
    pairsWith: ["cloud-matcha", "black-sesame-matcha-latte"],
  ...
  },
  {
    ...
    pairsWith: ["yuzu-matcha-sparkle", "peach-blossom-matcha"],
